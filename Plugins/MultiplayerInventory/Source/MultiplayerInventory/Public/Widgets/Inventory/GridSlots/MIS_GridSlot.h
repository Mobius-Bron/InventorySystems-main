...
#include "MIS_GridSlot.generated.h"
...
UCLASS()
class MULTIPLAYERINVENTORY_API UMIS_GridSlot : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	EMIS_GridSlotState GetGridSlotState() const { return GridSlotState; }
	TWeakObjectPtr<UMIS_InventoryItem> GetInventoryItem() const { return InventoryItem; }
	...
	void SetItemPopUp(UMIS_ItemPopUp* PopUp);
	UMIS_ItemPopUp* GetItemPopUp() const;
...
private:
	...
	TWeakObjectPtr<UMIS_ItemPopUp> ItemPopUp;
	...
	EMIS_GridSlotState GridSlotState;
