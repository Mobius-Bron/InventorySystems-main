...
void UOldMIS_ItemPopUp::NativeOnInitialized()
{
...
void UOldMIS_ItemPopUp::NativeOnMouseLeave(const FPointerEvent& InMouseEvent)
{
	Super::NativeOnMouseLeave(InMouseEvent);
	RemoveFromParent();
}

int32 UOldMIS_ItemPopUp::GetSplitAmount() const
{
	return FMath::FloorToInt(Slider_Split->GetValue());
}

void UOldMIS_ItemPopUp::CollapseSplitButton() const
{
...
void UOldMIS_ItemPopUp::CollapseConsumeButton() const
{
	Button_Consume->SetVisibility(ESlateVisibility::Collapsed);
}

void UOldMIS_ItemPopUp::SetSliderParams(const float Max, const float Value) const
{
...
FVector2D UOldMIS_ItemPopUp::GetBoxSize() const
{
...
void UOldMIS_ItemPopUp::SplitButtonClicked()
{
...
void UOldMIS_ItemPopUp::DropButtonClicked()
{
...
void UOldMIS_ItemPopUp::ConsumeButtonClicked()
{
...
void UOldMIS_ItemPopUp::SliderValueChanged(float Value)
{
	Text_SplitAmount->SetText(FText::AsNumber(FMath::FloorToInt(Value)));
}
