...
#include "SBI_EquipActor.generated.h"
 ...
 */
UCLASS()
class SANDBOXINVENTORY_API ASBI_EquipActor : public AActor
{
	GENERATED_BODY()
...
private:
	/** 装备类型标签 - 与装备槽位的 EquipmentTypeTag 匹配 */
	UPROPERTY(EditInstanceOnly, Category = "SandboxInventory")
